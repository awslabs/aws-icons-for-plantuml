...
BREAKING_CHANGES["v22.0"] = {
    "ArtificialIntelligence": {
        "REPLACED": {
            "SageMakerCanvas": "SageMakerAICanvas",
            "SageMakerGeospatialML": "SageMakerAIGeospatialML",
            "SageMakerModel": "SageMakerAIModel",
            "SageMakerNotebook": "SageMakerAINotebook",
