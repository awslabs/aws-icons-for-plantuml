...
The project is versioned to align with AWS Architecture Icons releases (e.g., v23.1-2026.04.28). The `dist/` directory is the published artifact; the `scripts/` directory contains the build tooling.
